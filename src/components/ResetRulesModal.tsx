...
interface ResetRulesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export default function ResetRulesModal({ isOpen, onClose, onConfirm }: ResetRulesModalProps) {
  useEffect(() => {
      ...
      >
        ...
        <div className="mb-6">
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            This will reset all engagement rules to their default values. Current customizations will be lost.
          </p>

          <div className="mt-4 p-4 bg-gray-50 dark:bg-white/5 rounded-lg">
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Default Values (Balanced 50-Point System):</h4>
            <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex justify-between">
                <span>No Response After 3 Contacts:</span>
                <span className="font-mono text-red-500">-15</span>
              </div>
            </div>
            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
              <div className="flex justify-between text-xs font-semibold">
                <span className="text-gray-700 dark:text-gray-300">Total Maximum Bonus:</span>
                <span className="text-apple-green">+50 points</span>
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Creates true 50/50 split with Group Score maximum
              </p>
            </div>
          </div>
        </div>
